...
public class Company implements java.io.Serializable{
    ...
    String id="", name="", address="", city="", state="", zip="",
		...
		static Logger logger = LogManager.getLogger(Company.class);
    String errors = "";
		...
		Bond bond = null; // latest
		Insurance insurance = null; // latest
    ...
    public String getWebsite(){
		...
		public String getFlaggedInfo(){
				String ret = "";
				if(hasInsurances()){
						if(insurance.isExpired()){
								ret = "Insurance expired";
						}
				}
				if(hasBonds()){
						if(bond.isExpired()){
